...
<div class="container">
    <div class="formLogin">
        ...
        <div class="contentForm">
            <div class="tabs">
                <button id="login" class="activeTap" >تسجيل الدخول</button>
                <button id="signUp" onclick="window.location.href = 'register'">التسجيل</button>
            </div>
                <h3>
                    @if(Session::get('msg'))
                        {{Session::get('msg')}}
            ...
            <form action="{{route("auth.logged")}}" id='formLogin' method="POST">
                @csrf
                <input type="text" name="email" placeholder="أدخل الايميل الخاص بك ..." value="{{old('lname')}}">
                ...
                <div class="actions">
                    ...
                    <div class="forget">
                        <a href="#"><span>هل نسيت كلمة المرور ؟</span></a>
                    </div>
