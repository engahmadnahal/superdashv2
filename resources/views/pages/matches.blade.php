                ...
                <div class="match">
                    <div class="ditals-match flex j-bet">
                        ...
                        <div class="actions flex j-center algin-center">
                            <form action="{{ route('pages.addmatch', $item->data_id) }}" method="post">@csrf <button
                                    id="addMatch"><span>اضافة المباراة</span></button></form>
                        </div>
                    </div>
                </div>
            @endif
        ...
        @forelse($matchesOfUser as $item)
            <div class="match">
                <div class="ditals-match flex j-bet">
                    ...
                    <div class="actions flex j-center algin-center">
                        <a href="{{ route('pages.editmatch', $item->data_id) }}"> <button
                                id="edit"><span>تعديل</span></button></a>
                        <form action="{{ route('pages.deletematch', $item->data_id) }}" method="post"> @csrf<button
                                id="edit"><span>حذف</span></button></form>
                    </div>
                </div>
            </div>
        @empty
